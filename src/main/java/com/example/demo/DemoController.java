...
public class DemoController {
    ...
    public ResponseEntity<String> racfCommand(@RequestBody String command,HttpSession session){
        ...
        if(ZOSMF_JSESSIONID==null || ZOSMF_LtpaToken2 == null){
            ...
            requestFactory.setHttpClient(httpClient);
            //提交jcl的zosmf地址
            String urlOverHttps="https://10.60.43.8:8800/zosmf/restjobs/jobs";
            //设置请求头
            HttpHeaders headers = new HttpHeaders();
            ...
            for(int i = 0; i<20;i++){
                ...
                //查询执行状态的地址
                urlOverHttps="https://10.60.43.8:8800/zosmf/restjobs/jobs/"+responseSub.getBody().getJobname()+"/"+responseSub.getBody().getJobid();
                //查询结果的request
